...
class VueThemeCache extends Singleton {
    ...
    protected function __construct(){
        ...
        add_action( 'save_post', array('VueThemeCache','flushOnSave'), 10, 3 );

        add_action( 'after_rocket_clean_cache_dir', array('VueThemeCache','emptyCache'));
    ...
    private function skipCache(){
        ...
        if($self->dev_mode || ($self->accept_vue_dev_mode && defined( 'VUE_DEV' ) && VUE_DEV == true)){
            return true;
        } else {
            return false;
        }
